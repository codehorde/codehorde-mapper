...
final class CglibUtils {
    ...
    public static <T> T newInstance(Class<T> clazz) {
        ...
        try {
            ...
            throw new RuntimeException("Can't create new instance [class=" + clazz + "].", e);
        }
    }
    ...
    public static String getTableClassSpec(Class<?> clazz) {
        try {
            ...
            throw new RuntimeException("Can't get class specification [class=" + clazz + "].", e);
        }
    }
    ...
    public static String getTableClassName(Class<?> clazz) {
        ...
        throw new RuntimeException("Can't get table class name [class=" + clazz + "].");
    }
